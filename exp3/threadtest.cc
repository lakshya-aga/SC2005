...
void TestValueOne()
{
	...
	Thread* thread2 = new Thread("Inc_v1_2");
	Thread* thread3 = new Thread("Dec_v1_1");
	Thread* thread4 = new Thread("Dec_v1_2");

	thread1->Fork(Inc_v1, 1, 1);
	thread1->Join(thread1);
	thread2->Fork(Inc_v1, 2, 1);
	thread2->Join(thread2);
	thread3->Fork(Dec_v1, 3, 1);
	thread3->Join(thread3);
	thread4->Fork(Dec_v1, 4, 1);
	thread4->Join(thread4);
...
void TestValueMinusOne()
{
	...
	thread1->Fork(Inc_v2, 1, 1);
	thread1->Join(thread1);
	thread2->Fork(Inc_v2, 2, 1);
	thread2->Join(thread2);
	thread3->Fork(Dec_v2, 3, 1);
	thread3->Join(thread3);
...
void TestConsistency()
{
	...
	//fill your code
	Thread* thread1 = new Thread("Inc_consistent1");
	Thread* thread2 = new Thread("Inc_consistent2");
	Thread* thread3 = new Thread("Dec_consistent1");
	Thread* thread4 = new Thread("Dec_consistent2");
